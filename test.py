...
class TestPymarlzooplusEnvironments(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        ############################################################
        # Arguments to test training framework in all environments

        # Arguments for PettingZoo
        cls.train_framework_params_dict["PettingZoo"] = {
            "config": "qmix",
            "algo_args": {
                "test_nepisode": 2,
                "test_interval": 2,
        ...
        ############################################################
        # Arguments to test training framework with all algorithms
        ...
        for pettingzoo_non_fully_coop_env_butterfly_mpe_sisl_key in pettingzoo_non_fully_coop_env_butterfly_mpe_sisl_keys:
