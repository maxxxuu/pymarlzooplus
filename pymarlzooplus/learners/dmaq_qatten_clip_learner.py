...
class DMAQ_qatten_clip_Learner:
    ...
    def __init__(self, mac, scheme, logger, args):
        ...
        self.optimiser = RMSprop([
            {"params": mac.parameters(), "lr": args.lr, "alpha": args.optim_alpha, 'eps': args.optim_eps},
            {"params": self.mixer.parameters(), "lr": args.lr/2, "alpha": args.optim_alpha, 'eps': args.optim_eps}
        ])
    ...
    def sub_train(self, batch,
        ...
        for group in optimiser.param_groups:
            grad_norm += th.nn.utils.clip_grad_norm_(group["params"], self.args.grad_norm_clip)
        optimiser.step()
