...
from pymarlzooplus.modules.layer.PESymetry import PESymetryMean, PESymetryMeanTanh
import torch as th


class RNNCentAgent(nn.Module):
    def __init__(self, input_shape, args):
        super(RNNCentAgent, self).__init__()
        self.args = args
        ...
        # RNN embedding
        self.fc1 = nn.Linear(input_shape * args.n_agents, args.hidden_dim)
    ...
    def init_hidden(self):
        ...
        return self.fc1.weight.new(self.n_agents, self.args.hidden_dim).zero_()
