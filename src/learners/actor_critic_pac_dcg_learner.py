...
class PACDCGLearner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        pi = mac_out
        advantages, critic_train_stats = self.train_critic_sequential(batch, rewards, critic_mask, terminated)
        actions = actions[:, :-1]
    ...
    def train_critic_sequential(self, batch, rewards, mask, terminated):
        ...
        q_curr = th.stack(q_curr, dim=1).unsqueeze(dim=-1) # Concat across time, starting at index 1
