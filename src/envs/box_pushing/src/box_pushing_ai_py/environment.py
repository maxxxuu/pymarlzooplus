...
class BoxPushing(gym.Env):
    ...
    def step(self, actions, debug=False):
        ...
        return observations, [rewards] * self.n_agent, int(terminate or self.count_step == self.terminate_step), {}
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            goal = rendering.FilledPolygon(
                [(-(screen_width - 8) / 2.0, (-50 + 2) * scale), (-(screen_width - 8) / 2.0, (50 - 2) * scale),
                 ((screen_width - 8) / 2.0, (50 - 2) * scale), ((screen_width - 8) / 2.0, -(50 - 2) * scale)])
            ...
            # -------------------draw small box
            small_box_0 = rendering.FilledPolygon([(-small_box_size / 2.0 * scale, -small_box_size / 2.0 * scale),
            ...
            self.small_box_0_trans = rendering.Transform(
                translation=(self.boxes[0].xcoord * 100 * scale, self.boxes[0].ycoord * 100 * scale))
            small_box_0.add_attr(self.small_box_0_trans)
            self.viewer.add_geom(small_box_0)

            small_box_0_in = rendering.FilledPolygon(
                [(-small_box_in_size / 2.0 * scale, -small_box_in_size / 2.0 * scale),
                 (-small_box_in_size / 2.0 * scale, small_box_in_size / 2.0 * scale),
                 (small_box_in_size / 2.0 * scale, small_box_in_size / 2.0 * scale),
                 (small_box_in_size / 2.0 * scale, -small_box_in_size / 2.0 * scale)])
            small_box_0_in.set_color(*small_box_clrs[1])
            self.small_box_0_in_trans = rendering.Transform(
                translation=(self.boxes[0].xcoord * 100 * scale, self.boxes[0].ycoord * 100 * scale))
            small_box_0_in.add_attr(self.small_box_0_in_trans)
            self.viewer.add_geom(small_box_0_in)

            small_box_1 = rendering.FilledPolygon([(-small_box_size / 2.0 * scale, -small_box_size / 2.0 * scale),
                                                   (-small_box_size / 2.0 * scale, small_box_size / 2.0 * scale),
                                                   (small_box_size / 2.0 * scale, small_box_size / 2.0 * scale),
                                                   (small_box_size / 2.0 * scale, -small_box_size / 2.0 * scale)])
            small_box_1.set_color(*small_box_clrs[0])
            self.small_box_1_trans = rendering.Transform(
                translation=(self.boxes[1].xcoord * 100 * scale, self.boxes[1].ycoord * 100 * scale))
            small_box_1.add_attr(self.small_box_1_trans)
            self.viewer.add_geom(small_box_1)

            small_box_1_in = rendering.FilledPolygon(
                [(-small_box_in_size / 2.0 * scale, -small_box_in_size / 2.0 * scale),
                 (-small_box_in_size / 2.0 * scale, small_box_in_size / 2.0 * scale),
                 (small_box_in_size / 2.0 * scale, small_box_in_size / 2.0 * scale),
                 (small_box_in_size / 2.0 * scale, -small_box_in_size / 2.0 * scale)])
            small_box_1_in.set_color(*small_box_clrs[1])
            self.small_box_1_in_trans = rendering.Transform(
                translation=(self.boxes[1].xcoord * 100 * scale, self.boxes[1].ycoord * 100 * scale))
            small_box_1_in.add_attr(self.small_box_1_in_trans)
            self.viewer.add_geom(small_box_1_in)

            # -------------------draw big box
            big_box_2 = rendering.FilledPolygon([(-big_box_l / 2.0 * scale, -big_box_w / 2.0 * scale),
                                                 (-big_box_l / 2.0 * scale, big_box_w / 2.0 * scale),
                                                 (big_box_l / 2.0 * scale, big_box_w / 2.0 * scale),
                                                 (big_box_l / 2.0 * scale, -big_box_w / 2.0 * scale)])
            big_box_2.set_color(*big_box_clrs[0])
            self.big_box_2_trans = rendering.Transform(
                translation=(self.boxes[2].xcoord * 100 * scale, self.boxes[2].ycoord * 100 * scale))
            big_box_2.add_attr(self.big_box_2_trans)
            self.viewer.add_geom(big_box_2)

            big_box_2_in = rendering.FilledPolygon([(-big_box_in_l / 2.0 * scale, -big_box_in_w / 2.0 * scale),
                                                    (-big_box_in_l / 2.0 * scale, big_box_in_w / 2.0 * scale),
                                                    (big_box_in_l / 2.0 * scale, big_box_in_w / 2.0 * scale),
                                                    (big_box_in_l / 2.0 * scale, -big_box_in_w / 2.0 * scale)])
            big_box_2_in.set_color(*big_box_clrs[1])
            self.big_box_2_in_trans = rendering.Transform(
                translation=(self.boxes[2].xcoord * 100 * scale, self.boxes[2].ycoord * 100 * scale))
            ...
            self.agent_0_trans = rendering.Transform(
                translation=(self.agents[0].xcoord * 100 * scale, self.agents[0].ycoord * 100 * scale))
            ...
            self.agent_0_in_trans = rendering.Transform(
                translation=(self.agents[0].xcoord * 100 * scale, self.agents[0].ycoord * 100 * scale))
            ...
            self.agent_1_trans = rendering.Transform(
                translation=(self.agents[1].xcoord * 100 * scale, self.agents[1].ycoord * 100 * scale))
            ...
            self.agent_1_in_trans = rendering.Transform(
                translation=(self.agents[1].xcoord * 100 * scale, self.agents[1].ycoord * 100 * scale))
            ...
            sensor_0 = rendering.FilledPolygon([(-sensor_size / 2.0 * scale, -sensor_size / 2.0 * scale),
                                                (-sensor_size / 2.0 * scale, sensor_size / 2.0 * scale),
                                                (sensor_size / 2.0 * scale, sensor_size / 2.0 * scale),
                                                (sensor_size / 2.0 * scale, -sensor_size / 2.0 * scale)])
            sensor_0.set_color(*sensor_clrs[0])
            self.sensor_0_trans = rendering.Transform(translation=(
            self.agents[0].xcoord * 100 * scale + (agent_size) * DIRECTION[self.agents[0].ori][0] * scale,
            ...
            sensor_0_in = rendering.FilledPolygon([(-sensor_in_size / 2.0 * scale, -sensor_in_size / 2.0 * scale),
                                                   (-sensor_in_size / 2.0 * scale, sensor_in_size / 2.0 * scale),
                                                   (sensor_in_size / 2.0 * scale, sensor_in_size / 2.0 * scale),
                                                   (sensor_in_size / 2.0 * scale, -sensor_in_size / 2.0 * scale)])
            sensor_0_in.set_color(*sensor_clrs[1])
            self.sensor_0_in_trans = rendering.Transform(translation=(
            self.agents[0].xcoord * 100 * scale + (agent_size) * DIRECTION[self.agents[0].ori][0] * scale,
            self.agents[0].ycoord * 100 * scale + (agent_size) * DIRECTION[self.agents[0].ori][1] * scale))
            sensor_0_in.add_attr(self.sensor_0_in_trans)
            self.viewer.add_geom(sensor_0_in)

            sensor_1 = rendering.FilledPolygon([(-sensor_size / 2.0 * scale, -sensor_size / 2.0 * scale),
                                                (-sensor_size / 2.0 * scale, sensor_size / 2.0 * scale),
                                                (sensor_size / 2.0 * scale, sensor_size / 2.0 * scale),
                                                (sensor_size / 2.0 * scale, -sensor_size / 2.0 * scale)])
            sensor_1.set_color(*sensor_clrs[0])
            self.sensor_1_trans = rendering.Transform(translation=(
            self.agents[1].xcoord * 100 * scale + (agent_size) * DIRECTION[self.agents[1].ori][0] * scale,
            ...
            sensor_1_in = rendering.FilledPolygon([(-sensor_in_size / 2.0 * scale, -sensor_in_size / 2.0 * scale),
                                                   (-sensor_in_size / 2.0 * scale, sensor_in_size / 2.0 * scale),
                                                   (sensor_in_size / 2.0 * scale, sensor_in_size / 2.0 * scale),
                                                   (sensor_in_size / 2.0 * scale, -sensor_in_size / 2.0 * scale)])
            sensor_1_in.set_color(*sensor_clrs[1])
            self.sensor_1_in_trans = rendering.Transform(translation=(
            self.agents[1].xcoord * 100 * scale + (agent_size) * DIRECTION[self.agents[1].ori][0] * scale,
            self.agents[1].ycoord * 100 * scale + (agent_size) * DIRECTION[self.agents[1].ori][1] * scale))
        ...
        self.small_box_0_in_trans.set_translation(self.boxes[0].xcoord * 100 * scale,
                                                  self.boxes[0].ycoord * 100 * scale)
        self.small_box_1_trans.set_translation(self.boxes[1].xcoord * 100 * scale, self.boxes[1].ycoord * 100 * scale)
        self.small_box_1_in_trans.set_translation(self.boxes[1].xcoord * 100 * scale,
                                                  self.boxes[1].ycoord * 100 * scale)
        ...
        self.sensor_0_in_trans.set_translation(
            self.agents[0].xcoord * 100 * scale + (agent_size) * DIRECTION[self.agents[0].ori][0] * scale,
            self.agents[0].ycoord * 100 * scale + (agent_size) * DIRECTION[self.agents[0].ori][1] * scale)
        ...
        self.sensor_1_in_trans.set_translation(
            self.agents[1].xcoord * 100 * scale + (agent_size) * DIRECTION[self.agents[1].ori][0] * scale,
            self.agents[1].ycoord * 100 * scale + (agent_size) * DIRECTION[self.agents[1].ori][1] * scale)
