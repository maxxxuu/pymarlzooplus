...
from utils.handle_import_errors import (
...
class _PettingZooWrapper(MultiAgentEnv):
    ...
    def set_environment(
        ...
        self.original_observation_space = self.__env.observation_space(self.__env.possible_agents[0])
        self.common_observation_space = all(
            [
                self.original_observation_space == self.__env.observation_space(self.__env.possible_agents[agent_id])
        ...
        if self.is_image is True:
            ...
            if self.common_observation_space is False:
                self.original_observation_space = self.__env.observation_spaces  # dictionary
        ...
        tmp_action_spaces_list = [
            self._env.action_space(possible_agent) for possible_agent in self._env.possible_agents
        ]
